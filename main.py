...
# 1. 配置 Gemini (通过 OpenAI 兼容协议)
api_key = os.environ.get("GEMINI_API_KEY")
if not api_key:
    raise ValueError("❌ 错误：未检测到 GEMINI_API_KEY，请在 GitHub Secrets 中配置！")
...
if __name__ == "__main__":
    ...
    远处，巨大的机甲残骸在夕阳下投射出长长的阴影，一只机械黑猫悄无声息地跳上了他的肩膀。
    """
